   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div  class="modal-header" >
            ...
            <h4><span class="glyphicon glyphicon-info-sign"></span> Clientes y Proveedores</h4>
         </div>
         <div class="modal-body" style="padding:40px 50px;">
            <form>
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                     <select class="form-control" id="a-tipo">
                     </select>
                  </div>
               </div>
               <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                     ...
                     <input type="text" id="n-doc" style="display: none;">
                  </div>
               </div>
               <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Nombre ó razón :</label>
                  <div class="col-sm-9">
                     <input id="a-nom" type="text" class="form-control form-control-round" placeholder="Nombre ó razón Social" autocomplete="off">
                  </div>
               </div>
               <div class="form-group row">
         ...
         <div class="modal-body" style="padding:40px 50px;">
            <form>
               ...
               <div class="row">
                  ...
                  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                     <label >Email </label>
                     <input  type="text"  class="form-control"  id="a-email-d" >
                  </div>
                  <div class="col-md-5 col-sm-12 col-xs-12  form-group">
                     <label >Urbanización </label>
...
<script type="text/javascript" src="js/dir-clientes.js"></script>